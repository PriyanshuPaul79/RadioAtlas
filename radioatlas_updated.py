...
def get_radio_stations_by_country(country):
    ...
    try:
        ...
        # Step 3: If API fails, try to load from cache
    ...
    if filtered_stations:
        ...
        if st.button("🎲 Radio Roulette"):
            ...
            if state['favorites']:
                ...
                potential_picks = [
                    s for s in stations 
                    if (fav_tags and set(s.get('tags', '').intersection(fav_tags))) or \
            ...
            if roulette_pick:
                ...
                st.write(f"**Language:** {roulette_pick.get('language', 'N/A')} | **Genre:** {roulette_pick.get('tags', 'N/A')}")
